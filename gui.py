...
class MainApplication(tk.Frame):
    def __init__(self, window):
        ...
        label_greeting = tk.Label(master=frame_greeting, text="Enter a review:")
        label_greeting.pack()
        frame_greeting.grid(row=0, column=0, padx=5, pady=5)

        text_box = tk.Text(master=frame_text)
        text_box.pack()
        frame_text.grid(row=1, column=0, padx=5, pady=5)
        ...
        frame_button.grid(row=2, column=0, padx=5, pady=5)
