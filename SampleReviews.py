...
class SampleReviews:
    ...
    def __init__(self):
        ...
        self.listOfReviews.append("Good! The chicken clay pot was full of flavor.  I also felt that the bavette and dumplings were great. I will return!")
        ...
        self.listOfReviews.append("Thank you to all the staff that bravely go to work everyday (amidst the ever changing news and being in SUCH close quarters to so many ppl) "
